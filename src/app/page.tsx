...
function CreateTaskLink() {
  return (
    <Link href="/create" className="mt-[-48px]">
      Create Task{" "}
      <Image
        src={RoundedPlus}
        alt=""
...
function TasksStatusBar(props: { tasks: Task[] }) {
  ...
  return (
    <div className="flex flex-col md:flex-row full justify-between pt-12">
      <span className="inline-block">
        <BlueLabel text="Tasks" />
        <span className="bg-darkGray text-lightGray ml-2 w-4 h-4 px-4 py-1 rounded-3xl">
          {tasks.length}
        </span>
      </span>
      <span className="inline-block">
